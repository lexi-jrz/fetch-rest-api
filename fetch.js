...
document.getElementById('previous-btn')
    ...
    function tarjeta (pokemon){
        document.getElementById('imgPoke').src = pokemon.sprites.front_shiny;
        document.getElementById('nomPoke').textContent = "Nombre: " + pokemon.name;
        document.getElementById('pesoPoke').textContent = "Peso: " + pokemon.weight + " gramos";
        document.getElementById('idPoke').textContent = "ID: " + pokemon.id;
    }
